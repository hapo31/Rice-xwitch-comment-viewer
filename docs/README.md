# Twitch Comment TTS Tool Design

このディレクトリは、Twitchのリアルタイムコメント取得と、棒読みちゃん/VOICEROID2系の読み上げ連携を統合するTauriアプリの設計メモです。

## 目次

- [要求と採用方針](./01-requirements-and-decisions.md)
- [全体アーキテクチャ](./02-architecture.md)
- [Twitchコメント受信](./03-twitch-ingestion.md)
...
1. Twitch EventSub WebSocketでコメントを受信する。
